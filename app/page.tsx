...
const speakers: Speaker[] = [
  ...
  },
  {
    ...
    topic: "Что на самом деле разрушает отношения раньше измен и предательств",
    description:
  ...
  {
    name: "Константин Суханов",
    role: "Врач-остеопат, психотерапевт и ведущий трансформационных практик",
    topic: "Как работа с телом и состоянием влияет на достижение целей в жизни и бизнесе",
    description:
      "Константин покажет, как телесные напряжения и устойчивые внутренние реакции ограничивают финансовый рост, забирают ресурс руководителя и удерживают бизнес в режиме постоянного личного контроля.",
    facts: [
      "Более 30 лет практического опыта",
      "Учился и жил в Тибете, Китае и Индии",
      "Принял саньясу",
      "Мастер даосских и тантрических практик",
      "Основатель Центра восстановительной медицины «Философия Здоровья доктора Суханова»",
    ],
    initials: "КС",
    tone: "night",
    image: "/speakers/konstantin-sukhanov.jpg",
...
const formats = [
  {
    ...
    text: "20 экспертов разберут знакомства, близость, секс, конфликты, деньги и личные границы.",
  },
  {
    number: "02",
    title: "Практики",
...
const connectionStatusCopy: Record<ConnectionStatus, string> = {
  ...
  },
  {
    ...
    topics: [
      "Почему деньги приходят, но не остаются?",
      "Как обсуждать вклад каждого без стыда, контроля и борьбы",
      "Где застревают деньги: анатомия финансовых зажимов",
    ],
    speakers: "Олеся Дроздова · Инна Мартынова · Константин Суханов",
  ...
  },
  {
    ...
    topics: [
      "Что на самом деле разрушает отношения раньше измен и предательств",
...
const speakerOutcomes: Record<string, string> = {
  ...
  "Константин Суханов": "Увидите, какие телесные и психологические зажимы удерживают финансовый рост и заставляют бизнес зависеть от вашего постоянного участия.",
};
...
const attendees = [
  ...
  { name: "Кристина", age: 25, reason: "Хочу пойти на фестиваль, прихожу за вдохновением и новыми знакомствами.", image: "/attendees/kristina-25.svg" },
];

...
const connectionStatusCopy: Record<ConnectionStatus, string> = {
  ...
  },
  {
    ...
    topics: [
      "Пространство между вами: союз, в котором оба расцветают",
    ...
    speakers: "Алёна Пересада · Светлана Федосеева · Люси Беликова · Катия Шведова · Елена Солнечная · Елена Забанова",

...
const GIFTS: Gift[] = [
  ...
  { id:"zhilnikova-game", partner:"Ольга Жильникова", title:"Игра «РАППОРТ»", price:3000, quantity:null, format:"Групповая практика", term:"До 30 сентября 2026", details:"Тренажёр отношений с разбором жизненных ситуаций и обратной связью психолога-сексолога." },

...
const PROVIDERS: Record<string, ProviderInfo> = {
  ...
  "Лала Попова": { bio:"Психолог по отношениям, реализации и психическому здоровью. Более 7500 часов индивидуальной практики.", publicHref:"https://t.me/Lala_Popova", publicLabel:"Telegram Лалы Поповой" },
...
const GIFT_VALUES: Record<string, GiftValue> = {
  ...
  lala:{forWhom:"Для тех, кто не может встретить партнёра, кому сложно развестись, кто хочет наладить отношения в паре, вернуть близость или боится снова обжечься.",includes:["40 минут онлайн-консультации","Разбор проблемы в отношениях","Определение причины проблемы","Конкретные решения по вашему запросу"],result:"Вы узнаете, в чём причина вашей проблемы и что делать, чтобы изменить сценарий отношений. При записи в Telegram напишите слово «отношения»."},
...
const GIFTS: Gift[] = [
  ...
  { id:"lala", partner:"Лала Попова", title:"Разбор сценариев в отношениях", price:8000, quantity:5, format:"Онлайн-консультация, 40 минут", term:"Действует с 22.08 по 22.09.2026", contact:"@Lala_Popova", details:"Разбор проблем и решений в отношениях. При записи напишите слово «отношения»." },
...
function giftContact(gift: Gift) {
  ...
  if (contact.startsWith("@")) return { href: `https://t.me/${contact.slice(1)}`, label: gift.id === "lala" ? `Записаться: «отношения» - ${contact}` : `Написать ${contact}` };
